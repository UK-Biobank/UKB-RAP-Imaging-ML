# UK Biobank Imaging Analysis on the RAP

This repository provides tools, workflows, and tutorials for analysing UK Biobank imaging data on the Research Analysis Platform (RAP). It brings together and builds upon tools and pipelines developed by researchers to process imaging datasets and derive relevant variables. The resource is designed to support scalable, reproducible analysis and will continue to grow as new methods and materials are added.
